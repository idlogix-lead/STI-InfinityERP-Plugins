...
public class WCreateFromTicketProductionUI extends CreateFromTicketProduction implements ActionListener, EventListener<Event>, ValueChangeListener
{
	...
	public WCreateFromTicketProductionUI(GridTab tab) 
	{
		super(tab);
	...
	/**	Logger			*/
	private final static CLogger log = CLogger.getCLogger(WCreateFromTicketProductionUI.class);
